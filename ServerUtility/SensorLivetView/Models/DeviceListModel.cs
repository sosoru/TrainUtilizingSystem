...
{
    internal class DeviceListModel : NotifyObject
    {
        /*
        ...
        {
            this.DeviceList = new ObservableCollection<IDevice<IDeviceState<IPacketDeviceData>>>();
            
        }

        public ObservableCollection<IDevice<IDeviceState<IPacketDeviceData>>> DeviceList { get; private set; }
    }
}
