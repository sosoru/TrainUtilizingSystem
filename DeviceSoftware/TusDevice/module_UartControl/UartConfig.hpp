...
namespace module_UartControl
{
	namespace Config
	{
		...
		typedef UartControl::TrainSensorModule<OutputPin0<PortA>, OutputPin1<PortA>, USART0, TimerCounter1, 8> TrainSensorA;
		typedef UartControl::TrainSensorModule<OutputPin3<PortA>, OutputPin2<PortA>, USART0, TimerCounter1, 8> TrainSensorB;
