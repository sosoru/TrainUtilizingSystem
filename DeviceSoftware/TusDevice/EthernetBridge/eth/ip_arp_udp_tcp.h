...
extern void make_udp_request(uint8_t *buf, uint8_t *data, uint8_t datalen, uint16_t srcport, uint16_t dstport, arp_record *parp);

extern void make_arp_request(uint8_t *buf, uint8_t * pdestip);
